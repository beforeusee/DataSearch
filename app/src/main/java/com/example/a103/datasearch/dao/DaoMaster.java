...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        ...
        MachineDao.createTable(db, ifNotExists);
        ...
        CuttingParaDetailsDao.createTable(db, ifNotExists);
        CuttingConditionsDao.createTable(db, ifNotExists);
    }

    /** Drops underlying database table using DAOs. */
    public static void dropAllTables(Database db, boolean ifExists) {
        CoefficientParametersDao.dropTable(db, ifExists);
        MachineDao.dropTable(db, ifExists);
        ...
        CuttingParaDetailsDao.dropTable(db, ifExists);
        CuttingConditionsDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(MachineDao.class);
        ...
        registerDaoClass(CuttingParaDetailsDao.class);
        registerDaoClass(CuttingConditionsDao.class);
    }
